...
train_gen = work_dr.flow_from_directory(directory=work_dir, target_size=image_dim, batch_size=1000, shuffle=True)
...
layers_dims = [input_dim, 32, 16, 4]

nn = NeuralNetwork(layers_dims=layers_dims, activation="sigmoid", loss="categorical-cross-entropy", num_iterations=2000)
